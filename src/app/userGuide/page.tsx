    ...
    <>
      <div className="container mx-auto py-10">
        ...
        <p className="pt-5 font-light text-justify text-base">
          Welcome to the Blood Grouping Machine by Lifeline! This user guide
          will walk you through the process of using the machine to determine
          the blood group of a blood sample using advanced AI technology. Please
        ...
        <div className="m-5">
                  ...
                  <AccordionItem value="item-1-4" className="ml-10">
                    ...
                    <AccordionContent>
                      <ul className="list-disc pl-11 pt-2 space-y-2 font-light">
                        ...
                        <li>
                          Click <span className="font-bold">Capture</span> to
                          take a photo of the solution.
                        </li>
                        <li>
                          The built-in model of the program will analyze the
                          photo to determine the blood group of the sample.
                        </li>
                      </ul>
                    </AccordionContent>
                  </AccordionItem>
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                <div className="mb-4 font-light">
                  To ensure the optimal performance of the Blood Grouping
                  Machine, follow these maintenance tips:
                </div>
                <Accordion type="single" collapsible>
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                <div className="mb-4 font-light">
                  Proper storage is essential for preserving the longevity of
                  the machine:
                </div>
                <Accordion type="single" collapsible>
                  <AccordionItem value="item-1-1" className="ml-5">
        ...
        <div className="mt-10">
          <p className="font-light italic text-xs">
            Thank you for choosing Lifeline&apos;s Blood Grouping Machine. If
            you have any questions or need further assistance, please contact
            Lifeline Technologies at
